...
public class DataManager {
    ...
    /**
     * Escribe el fichero con los pokemons capturados
    ...
    /**
     * Este metodo entra en modo batalla con un pokemon legendario, el cual no gasta pokeballs pero si puede gastar intentos.
     * @param pokemon
     * @return
     */
    private boolean resultadoCapturaMi(Pokemon pokemon){
        ...
        do {
            System.out.println("Tens pokeball il·limitades " + intents + " intets, quina pokeball vols?");
            do {
    ...
    /**
     * Obtiene un color aleatorio para escribir en el estilo de css
     * @return
     */
    ...
    /**
     * Añade informacion al pokemon,para luego escribir informacion sobre el.
     * @param pokemon
     */
